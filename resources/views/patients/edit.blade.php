        ...
        <div class="col-md-12">
            <div class="widget wgreen">
                <div class="widget-head">
                    <div class="pull-left">Sửa bệnh nhân</div>
                ...
                <div class="widget-content">
                    <div class="padd form-content form-group">
                        <br />
                        <!-- Form starts.  -->
                        {{ Form::open(['route' => ['patients.update', $patient->id], 'files' => true, 'class' => 'form-horizontal']) }}
                            {{ method_field('PUT') }}
                            <div class="col-lg-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <label class="gender-radio">
                                            <input type="radio" name="gender" value="1" {{ $patient->gender ? 'checked' : '' }}> Nam
                                        </label>
                                        <label class="gender-radio">
                                            <input type="radio" name="gender" value="0" {{ $patient->gender ? '' : 'checked' }}> Nữ
                                        </label>
