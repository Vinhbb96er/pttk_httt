        ...
        <div class="col-md-12">
            <div class="widget wgreen">
                <div class="widget-head">
                    <div class="pull-left">Thêm bệnh án</div>
                ...
                <div class="widget-content">
                    <div class="padd form-content form-group">
                        <br />
                        <!-- Form starts.  -->
                        {{ Form::open(['route' => 'medical-records.store', 'files' => true, 'class' => 'form-horizontal']) }}
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Chọn bệnh nhân(*)</label>
                                    <div class="col-lg-5">
                                        <select class="form-control" name="patient" value="{{ old('patient') }}">
